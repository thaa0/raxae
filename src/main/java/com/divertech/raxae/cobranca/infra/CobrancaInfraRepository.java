...
public class CobrancaInfraRepository implements CobrancaRepository {
    ...
    @Override
    public List<Cobranca> findByGrupoIdAndUsuarioId(UUID grupoId, UUID usuarioId) {
        return jpaRepository.findByDespesaGrupoIdAndUsuarioId(grupoId, usuarioId);
    }
    ...
    @Override
    public List<Cobranca> buscarCobrancasPorGrupo(UUID grupoId) {
        return jpaRepository.findByDespesaGrupoId(grupoId);
    }
