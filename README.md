...
**POST** `http://localhost:8080/raxae/api/v1/auth/cadastro`
...
### 3. Criar Grupo (com Token)

**POST** `http://localhost:8080/raxae/api/v1/grupo`
...
**POST** `http://localhost:8080/raxae/api/v1/grupos/{grupoId}/despesas`
